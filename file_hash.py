...
if __name__ == '__main__':
    txn_id = hash_doc('/Users/dhanyajayachandra/Downloads/Census '
                   '2011_percentages.csv', action='store')
    res = hash_doc('/Users/dhanyajayachandra/Downloads/Census '
                   '2011_percentages.csv', action='verify', txn_id=txn_id)
    print(res)
